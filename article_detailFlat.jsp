...
<%
	...
	String sql = "select * from article where rootid = "+ id ;//为什么加上排序后就报错order by pdate asc
...
<div style="border-top:1px #a9d46d solid;" class="div0">
  ...
  <div class="post">
    <div class="otherinfo">
	  <div class="floor"><a href="http://bbs.bccn.net/thread-493382-1-1.html###" title="复制本楼链接到剪贴板" onclick="setcopy(&#39;https://bbs.bccn.net/viewthread.php?tid=493382&amp;page=1#pid2696719&#39;, &#39;本楼链接已经复制到剪贴板&#39;)"> <b><%=floor %></b> </a>
		</div>
...
<div class="div0">
  ...
  <div class="p_b">
			...
			<!-- huifutiezi -->	<a href="reply.jsp?id=<%=a.getId()%>&rootId=<%=a.getRootId() %>"><img src="./images_detail/reply_a.gif"></a>
